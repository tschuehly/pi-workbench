...
The focused [Level 1 child execution plan](../../../plans/level-1-subagents.md) defines the bounded implementation
...
[Working Mode plan](../../../plans/working-mode.md) covers the evidence-backed attended extension; managed
