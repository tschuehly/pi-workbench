...
function applyFakeRecord(snapshot, record, metadata) {
  switch (record.type) {
    ...
    case "checkpoint.replaced": Object.assign(session(snapshot, record.payload.sessionId), { latestCheckpoint: { ...structuredClone(record.payload.checkpoint), nextSessionPrompt: record.payload.checkpoint.nextSessionPrompt ?? null }, checkpointFailure: null, checkpointStaleness: null }); break;
