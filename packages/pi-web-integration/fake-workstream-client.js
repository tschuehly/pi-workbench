...
function applyFakeRecord(snapshot, record, metadata) {
  switch (record.type) {
    ...
    case "checkpoint.replaced": Object.assign(session(snapshot, record.payload.sessionId), { latestCheckpoint: structuredClone(record.payload.checkpoint), checkpointFailure: null, checkpointStaleness: null }); break;
